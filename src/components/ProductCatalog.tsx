...
export const ProductCatalog = () => {
  ...
  // ... (Load logic sama seperti sebelumnya) ...
  async function load() {
    try {
      setLoading(true);
    ...
    <section id="produk" className="py-12 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-10 space-y-6">
          {/* Weight Filter - Scrollable horizontally on extremely small screens if needed, otherwise wrap */}
          <div>
        ...
        {/* Product Grid - Adjusted gaps and columns */}
        {loading ? (
